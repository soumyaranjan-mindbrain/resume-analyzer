...
const JobReadiness = () => {
  ...
  const readyStudents = [
    { id: 1, name: 'Alex Rivera', role: 'Full Stack Developer', match: 94, readiness: 'Ready', score: 85 },
    { id: 2, name: 'Sarah Chen', role: 'Data Scientist', match: 96, readiness: 'Ready', score: 92 },
    { id: 3, name: 'Elena Vance', role: 'Product Designer', match: 88, readiness: 'Ready', score: 88 },
    { id: 4, name: 'Marcus Bell', role: 'Backend Engineer', match: 82, readiness: 'Developing', score: 74 },
    { id: 5, name: 'David Kim', role: 'DevOps Engineer', match: 85, readiness: 'Ready', score: 78 },
    { id: 6, name: 'James Wilson', role: 'Product Manager', match: 91, readiness: 'Ready', score: 88 },
  ];
      ...
      <div className="bg-white rounded-xl border border-slate-200 shadow-sm flex flex-col h-full">
        <div className="p-4 border-b border-slate-200 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <span className="bg-blue-50 text-blue-700 text-[11px] px-2 py-0.5 rounded-full font-bold border border-blue-100">850 Candidates</span>
            </div>
            <div className="flex items-center gap-3">
