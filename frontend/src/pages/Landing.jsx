    ...
    >
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2.5 cursor-pointer" onClick={() => navigate('/')}>
          ...
          <span className="text-[15px] font-semibold tracking-tight text-white">Aptica Resume</span>
        </div>
  ...
  return (
    <section ref={heroRef} className="relative min-h-screen flex flex-col items-center justify-center pt-24 pb-12 overflow-hidden">
      ...
      <div className="container mx-auto px-6 text-center max-w-4xl">
        ...
        <h1
          ref={titleRef}
          className="text-[clamp(2.5rem,8vw,5.5rem)] font-extrabold leading-[1.05] tracking-tight mb-6 overflow-hidden"
        >
          { "Aptica AI: Deep Resume Intelligence.".split(" ").map((word, i) => (
            <span key={i} className="inline-block mr-[0.2em] last:mr-0 overflow-hidden py-2">
        ...
        >
          Built for real hiring systems. Experience AI-powered resume analysis that 
          delivers ATS-optimized insights and high-impact optimizations.
        </p>
...
const ProductPreview = () => {
  ...
  return (
    <section ref={containerRef} className="pb-24 px-6 perspective-1000">
      <div className="max-w-5xl mx-auto">
        <div
          ref={cardRef}
          className="relative rounded-[1.75rem] p-[1px] bg-gradient-to-b from-gray-700/60 via-gray-800/30 to-transparent shadow-[0_40px_100px_rgba(0,0,0,0.5)] transform-gpu"
        >
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-8 py-12">
          ...
          <div className="flex items-center gap-2.5 cursor-pointer" onClick={() => navigate('/')}>
            ...
            <span className="text-sm font-semibold text-white">Aptica AI</span>
          </div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 py-5 border-t border-white/[0.04] text-[11px] text-gray-700">
          <p>© 2026 Aptica AI. All rights reserved.</p>
